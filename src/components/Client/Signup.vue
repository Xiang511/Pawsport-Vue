...
const handleGoogleSignUp = async () => {
  console.log('🔵 [Google SignUp] 開始執行...')
  ...
  try {
    ...
    console.log('🟢 [Google SignUp] 後端回應:', backendResponse.data)
            ...
            <div>
                  ...
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      <input
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:disabled:bg-gray-800" />
                    </div>
                  </div>
                  <!-- Email -->
                  <div>
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        placeholder="請輸入你的密碼"
                        :disabled="isEmailSent"
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:disabled:bg-gray-800" />
                      <span
              ...
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                <button
                  ...
                  <span>{{ isGoogleLoading ? '註冊中...' : 'Google' }}</span>
                </button>
              </div>
              <div class="mt-5">
                <p
