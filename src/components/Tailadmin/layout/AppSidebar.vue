...
import BoxCubeIcon from '@/components/Tailadmin/icons/BoxCubeIcon.vue'
...
const menuGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: PageIcon,
        subItems: [
          { name: 'Black Page', path: '/dashboard/blank', pro: false },
          { name: '404 Page', path: '/dashboard/error-404', pro: false },
        ],
      },
    ],
  },
