...
const handleSubmit = async () => {
  loading.value = true
  try {
    const response = await request.post('/PassPort', form.value)
...
<template>
  ...
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <div
      class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      <div class="border-b border-gray-200 bg-gray-50/50 px-7 py-4 dark:border-gray-800">
      ...
      <div class="grid grid-cols-1 gap-6 p-7 md:grid-cols-2">
        <div>
          ...
          <input
            v-model="form.treatmentLocation"
            type="text"
            class="focus:border-primary w-full rounded-lg border border-gray-300 bg-transparent px-5 py-3 outline-none dark:border-gray-700" />
        </div>
        <div>
    ...
    <div
      ...
      <div class="grid grid-cols-1 gap-6 p-7 md:grid-cols-2">
        ...
        <div>
          ...
          <input
            v-model="form.vaccinationLocation"
            type="text"
            class="focus:border-primary w-full rounded-lg border border-gray-300 bg-transparent px-5 py-3 outline-none dark:border-gray-700" />
        </div>
        <div>
