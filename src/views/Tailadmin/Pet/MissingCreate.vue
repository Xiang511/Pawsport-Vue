    ...
    <div class="p-7">
      <form @submit.prevent="handleSubmit">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div>
            <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">申報人 ID (UserId)</label>
            <input
          ...
          <div class="md:col-span-2">
            <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">走失地點文字描述</label>
            <input
          ...
          <div>
            <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">最後目擊緯度 (Lat)</label>
            <input
          ...
          <div>
            <label class="mb-2.5 block text-sm font-medium text-gray-800 dark:text-white/90">最後目擊經度 (Lng)</label>
            <input
